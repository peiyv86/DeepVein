...
DeepVein 的诞生离不开以下优秀开源项目的支持：

  * [Ollama](https://ollama.com/) - 优秀的本地大模型运行引擎。
  * [Hnswlib](https://github.com/nmslib/hnswlib) - 高效的纯内存高维向量图搜索库。
  * [nlohmann/json](https://github.com/nlohmann/json) - C++ 的高效 JSON 解析工具。
